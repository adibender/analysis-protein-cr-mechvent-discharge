...
# model objects
# subgroup: BMI 2 (18.5 - 30)
m_2_A_bmi2 <- readRDS(paste0(main_subfolder, "/models/m_2_A_bmi2.Rds")) # cause specific: death
m_2_B_bmi2 <- readRDS(paste0(main_subfolder, "/models/m_2_B_bmi2.Rds")) # cause specific: extubation
# subgroup: BMI 3 (> 30)
m_2_A_bmi3 <- readRDS(paste0(main_subfolder, "/models/m_2_A_bmi3.Rds")) # cause specific: death
m_2_B_bmi3 <- readRDS(paste0(main_subfolder, "/models/m_2_B_bmi3.Rds")) # cause specific: extubation
...
table(patient$bmi_cat) # exclude bmi < 18.5 group, as sample size too small
# subgroup_data
patient_bmi2 <- filter(patient, bmi_cat == "bmi18.5-30")
patient_bmi3 <- filter(patient, bmi_cat == "bmi>30")
daily_bmi2 <- daily %>% filter(CombinedID %in% patient_bmi2$CombinedID)
daily_bmi3 <- daily %>% filter(CombinedID %in% patient_bmi3$CombinedID)



## subgroup BMI 2 (18.5 - 30)
f6 <- make_six_frames(m_2_A_bmi2, patient_bmi2, daily_bmi2, ll,
  var1 = "proteinCat2", var2 = "proteinCat3", type = "1", effect = "proteinCat",
  surv_max = max.follow)
f6_extubation <- make_six_frames(m_2_B_bmi2, patient_bmi2, daily_bmi2, ll,
  var1 = "proteinCat2", var2 = "proteinCat3", type = "1", effect = "proteinCat",
  surv_max = max.follow)
...
ggsave(p_1,
  file = paste0(main_subfolder,
    "/results/figures/supplement/sub_bmi2_protein_effect_comparisons_1.png"),
  height = 9,
  width = 9)
...
ggsave(p_2,
  file = paste0(main_subfolder,
    "/results/figures/supplement/sub_bmi2_protein_effect_comparisons_2.png"),
  height = 9,
  width = 9)

## subgroup BMI 3 (> 30)
f6 <- make_six_frames(m_2_A_bmi3, patient_bmi3, daily_bmi3, ll,
  var1 = "proteinCat2", var2 = "proteinCat3", type = "1", effect = "proteinCat",
  surv_max = max.follow)
f6_extubation <- make_six_frames(m_2_B_bmi3, patient_bmi3, daily_bmi3, ll,
  var1 = "proteinCat2", var2 = "proteinCat3", type = "1", effect = "proteinCat",
  surv_max = max.follow)
...
ggsave(p_1,
  file = paste0(main_subfolder,
    "/results/figures/supplement/sub_bmi3_protein_effect_comparisons_1.png"),
  height = 9,
  width = 9)
...
ggsave(p_2,
  file = paste0(main_subfolder,
    "/results/figures/supplement/sub_bmi3_protein_effect_comparisons_2.png"),
  height = 9,
  width = 9)
